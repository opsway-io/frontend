    ...
    <Container maxWidth="xl">
      <Stack spacing={2}>
        ...
        <p>
          ...
          materials on opsway's Website for personal, non-commercial transitory
        ...
        <p>
          ...
          all other warranties. Furthermore, opsway does not make any
        ...
        <p>
          ...
          any time without notice. opsway does not make any commitment to update
          the materials.
        </p>
        ...
        <p>
          opsway has not reviewed all of the sites linked to its Website and is
          not responsible for the contents of any such linked site. The presence
          of any link does not imply endorsement by opsway of the site. The use
        ...
        <p>
          Any claim related to opsway's Website shall be governed by the laws of
          dk without regards to its conflict of law provisions.
        </p>
      </Stack>
    </Container>
  );
