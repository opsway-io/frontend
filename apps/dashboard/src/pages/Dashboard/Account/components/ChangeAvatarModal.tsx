...
interface ChangeAccountAvatarModalProps {
  userId?: string | number;
  open: boolean;
  onClose?: (ok: boolean) => void;
}

const ChangeAccountAvatarModal: FunctionComponent<
  ChangeAccountAvatarModalProps
> = (props) => {
  // Image selection
  ...
  const handleCropAndSubmit = async () => {
    if (!props.userId || !image || !croppedAreaPixels) {
      return;
    }
    ...
    try {
      await UsersAPI.updateAvatar(props.userId, croppedImage);
    } catch (error) {
...
export default ChangeAccountAvatarModal;
