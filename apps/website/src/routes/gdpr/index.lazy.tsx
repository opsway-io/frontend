    ...
    <Container maxWidth="xl">
      <Stack spacing={2}>
        ...
        <p>
          ...
          by opsway.io and how we use it.
        </p>
        <p>
        ...
        <p>
          opsway legal basis for collecting and using the personal information
        ...
        <ul>
          <li>opsway needs to perform a contract with you</li>
          <li>You have given opsway permission to do so</li>
          <li>
            Processing your personal information is in opsway legitimate
            interests
          </li>
          <li>opsway needs to comply with the law</li>
        </ul>
        <p>
          opsway will retain your personal information only for as long as is
        ...
        <h2>Log Files</h2>
        <p>
          opsway.io follows a standard procedure of using log files. These files
        ...
        <p>
          ...
          advertisements and links that appear on opsway.io, which are sent
        ...
        <p>
          ...
          shared and/or collect in opsway.io. This policy is not applicable to
